classdef SeqCnnMlpNet2D < SeqCnnMlpLayers2D & BaseNet2D & SeqCNNRNNInputNet2D
    ...
    methods
        ...
        function net = SeqCnnMlpNet2D(x_off, x_in, t_in, y_off, y_out, t_out, ini_rate, max_epoch)

            net = net@SeqCnnMlpLayers2D();
            net = net@BaseNet2D(x_off, x_in, t_in, y_off, y_out, t_out, ini_rate, max_epoch);
            net = net@SeqCNNRNNInputNet2D();

            net.name = "seqcnnmlp2d";
