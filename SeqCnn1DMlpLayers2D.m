    ...
    methods
        ...
        function net = Create(net)
            ...
            layers = [
                ...
                sequenceInputLayer([net.x_in 1],'Normalization','none','Name','Input')
                convolution1dLayer([net.x_in f_h], f_n, 'Stride',[net.x_in f_s], 'DilationFactor',[1 p_s], 'Padding','same', 'PaddingValue','replicate', 'Name','Conv1')
