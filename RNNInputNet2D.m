classdef RNNInputNet2D < MLPInputNet2D
    ...
    methods
        ...
        function [net, Xl, Yl, Bli, Blo, k_lob] = TrainTensors(net, M, l_sess, n_sess, norm_fli, norm_flo)
            [Xl, Yl, Bli, Blo, k_lob] = generic_train_seq_tensors2D(M, net.x_in, net.t_in, net.y_out, net.t_out, l_sess, n_sess, norm_fli, norm_flo);
            net.k_lob = k_lob;
