classdef SeqCnnNet2D < SeqCnnLayers2D & BaseNet2D & SeqCNNRNNInputNet2D
    ...
    methods
        ...
        function net = SeqCnnNet2D(x_off, x_in, t_in, y_off, y_out, t_out, ini_rate, max_epoch)

            net = net@SeqCnnLayers2D();
